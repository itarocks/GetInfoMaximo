...
<body>
			...
			<div id="header-content">
				<nav id="main-nav">
					...
					<ul class="clearfix">
						...
						<li><a href="/pages/sobre-a-casa-do-codigo" rel="nofollow"><fmt:message key="menu.sobre">
						</fmt:message></a></li>
						<li><a href="?locale=pt" rel="nofollow"><fmt:message key="menu.pt">
						</fmt:message></a></li>
						<li><a href="?locale=en_US" rel="nofollow"><fmt:message key="menu.en">
						</fmt:message></a></li>
	...
	<nav class="categories-nav">
		<ul class="container">
			<li class="category">
			<a href="${s:mvcUrl('HC#index').build() }"><fmt:message key="navegacao.categoria.home"/></a></li>
